	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <img class="subheading" src="images/hmlk.png" width="8%" height="5%">
	          ...
	          <li class="nav-item"><a href="login.php" class="nav-link">Your Parents' Information</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_3.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
		...
		<section class="ftco-section">
         ...
         <?php
		 include "db.php";
$sql1="SELECT * FROM teachersbookings;";
...
while($row1=$result1->fetch_assoc()){
	echo"<tr><td>".$row1["Parent Name"]."</td><td>".$row1["Bookings"]."</td><td>".$row1["Confirm class"]."</td><td>".$row1["Payments"]."</td></tr>";} 
echo"</table>";
