<?php
   ...
   if(isset($_REQUEST["submit"])) {
      ...
      $sql = "SELECT FullName FROM teacher WHERE Email = '$myusername' and Password = '$mypassword'";
...
<?php
   ...
   if(isset($_REQUEST["submit1"])) {
      ...
      $sql1 = "SELECT Name FROM parent WHERE Email = '$myusername' and Password = '$mypassword'";
